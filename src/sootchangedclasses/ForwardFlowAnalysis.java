...
/* Kunal:
 * Added code (lines 143-157) to handle a wierd piece of code generated by SOOT: 3 branches merging at the end of an if statement
 * that induces errors in ControlFlowAnalysis
 * 
 * 
 * */
public abstract class ForwardFlowAnalysis<N,A> extends FlowAnalysis<N,A>
{
    ...
    public ForwardFlowAnalysis(DirectedGraph<N> graph)
    {
        super(graph);
        //Daniel's Thoughts:
        //Why isn't do analysis called here?
    }
...
//        Timers.v().orderComputation.end();
       /*Added by kunal*/
        HashSet<N> processed =  new HashSet<N>(); 
        HashSet<N> merged =  new HashSet<N>(); 
        ...
        // Perform fixed point flow analysis
        {
            ...
            while(!changedUnits.isEmpty())
            {
                ...
                if(previousAfterFlow instanceof ControlFlowSet){
                	ControlFlowSet cntrlFlow = (ControlFlowSet) previousAfterFlow;
                	if(cntrlFlow.getStmtStack().toString().equals("[if temp$5 == 0 goto nop, tableswitch(temp$73) {     case 1: goto nop;     case 2: goto nop;     case 3: goto nop;     case 4: goto nop;     case 5: goto nop;     case 6: goto nop;     case 7: goto nop;     case 8: goto nop;     case 9: goto nop;     case 10: goto nop;     case 11: goto nop;     case 12: goto nop;     case 13: goto nop;     case 14: goto nop;     case 15: goto nop;     case 16: goto nop;     case 17: goto nop;     case 18: goto nop;     case 19: goto nop;     case 20: goto nop;     default: goto nop; }, if temp$1 > 0 goto nop, if temp$7 == 0 goto nop, if prompt != null goto nop]")){
                		int debug =1;
                		int a = debug;
                	}
                }
                // Compute and store beforeFlow
                {
                    ...
                    else if(preds.size() != 0)
                    {
                        ...
                        /**************Start of added code***************************/
                        HashSet<N> processedPreds = new HashSet<N>();
                        
                        for (N n : preds) {
							if(processed.contains(n))
								processedPreds.add(n);
						}
                        predIt = processedPreds.iterator();
                        
                        if(processedPreds.size()!=0){
	                        /**************End of added code***************************/
                        	if(processedPreds.size() == preds.size())
                        		merged.add(s);
                        	
	                        copy(unitToAfterFlow.get(predIt.next()), beforeFlow);
	
	                        /**************Start of added code***************************/
	                        /*Added code for a weird piece of code generated by SOOT 3 branches merging at the end of an if ststement
	                         * that induces errors in ControlFlowAnalysys*/
	                        if(preds.size() == 3 && this instanceof ControlFlowAnalysis){
	                        	
	                        	int num = AppUtil.getStatementLineNumber((Stmt)s);
	                        	while(predIt.hasNext())
	 	                        {
	                        		N n = predIt.next();
	                        		if(n.toString().contains("goto") && ((ControlFlowSet)unitToAfterFlow.get(n)).size() == 0)
	                        			continue;
	 	                            A otherBranchFlow = unitToAfterFlow.get(n);
